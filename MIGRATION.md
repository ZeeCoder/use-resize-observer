...
You now need React 18.2 or newer; anything older is no longer supported. The peer
range has no upper bound (`>=18.2`), so future React majors are accepted without
needing a release here.
